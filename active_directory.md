...
1. Cliquez sur 'Créer VM' (premier bouton bleu en haut à droite).
...
2. Dans l'onglet 'Général', choisissez le nom de votre machine virtuelle puis dans la partie 'Avancé' cochez 'Démarrer au boot'.
...
3. Dans l'onglet 'OS', choisissez votre image ISO.
...
4. Dans l'onglet 'Disque Dur', choisissez 'SATA' dans 'Bus/Device'.
...
5. Dans l'onglet 'Mémoire', choisissez '4096' dans 'Mémoire (MiB)'.
...
6. Dans l'onglet 'Confirmation', cliquez sur 'Terminé'.
...
7. Votre machine virtuelle devrait maintenant apparaître dans l'onglet de gauche sous 'pve'.
...
8. Cliquez sur cette dernière pour voir son tableau de bord.
